...
1. Clone the repository: git clone https://github.com/Abinaya611/grocery-store-webapp.git
...
This project is for my personal learning and internship demonstration purposes only.

For security, remember to change the placeholder in database connection instead of hardcoding sensitive credentials.
